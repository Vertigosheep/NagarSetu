-- COMPLETE DATABASE SETUP FOR CIVIC CONNECT
...
-- ============================================================================
-- 2. ISSUES TABLE (with coordinates!)
-- ============================================================================
...
-- Check issues table has all required columns
SELECT column_name, data_type 
FROM information_schema.columns 
WHERE table_name = 'issues' 
AND column_name IN ('latitude', 'longitude', 'after_image', 'citizen_feedback', 'department')
...
-- Next steps:
-- 1. Refresh your app
-- 2. Landing page statistics should work
-- 3. Navigation features will work for new issues
